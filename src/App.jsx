...
const projects = [
  {
    ...
    link: "",
    tags: ["React Native", "Figma", "JavaScript"],
  },
  {
    title: "Reef Guardian Game",
  ...
  },
  {
    ...
    link: "https://github.com/madi6116/OW2-Stats-Tracker",
  ...
  },
  {
    ...
    link: "https://www.figma.com/proto/ay65PCiQElNKbUrZYl3UXi/Hacktivism-II-Mockups---Fall-2025",
  ...
  },
  {
    ...
    link: "https://www.linkedin.com/in/madison-ammirati/overlay/Project/1415640629/treasury/?profileId=ACoAAEcpmVEBlc5uJnZTn34-Xdh2TulTDI5SNUI",
...
const skills = {
  ...
  Certifications: [
    ...
    "Google's Cybersecurity Certificate (IN PROGRESS)",
  ],
};
...
export default function App() {
  ...
  return (
    <>
      ...
      >
        ...
        >
          {/* Grid background */}
          <Aurora
            colorStops={["#00e5a0", "#0077ff", "#00e5a0"]}
            amplitude={1.0}
            blend={0.5}
            speed={1.0}
          />
          ...
          <div
            style={{
              ...
              height: "500px",
              background:
                "radial-gradient(circle, rgba(0,119,255,0.1) 0%, transparent 70%)",
              borderRadius: "50%",
              pointerEvents: "none",
            }}
          />
        ...
        <section
          id="about"
          className="section"
          style={{ maxWidth: "900px", margin: "0 auto", padding: "100px 24px" }}
        >
          ...
          <Reveal>
            ...
            >
              ...
              >
                Motivated and detail-oriented aspiring Software Engineer seeking
                internship opportunities to leverage academic knowledge and gain
                hands-on experience. Highly adept at problem-solving, software
                development, and team collaboration, with a strong commitment to
                innovation and excellence. Interested in roles that allow me to
                work on cybersecurity, software development, and UI/UX design,
                where I can contribute my skills and grow as a professional in
                the tech industry.
              </p>
              <div style={{ display: "flex", gap: "14px" }}>
                <a
                  href="https://www.linkedin.com/in/madison-ammirati/"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <a
                  href="https://github.com/madi6116"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="social-btn"
                >
                ...
                <a
                  href="mailto:madison.ammirati@gmail.com"
                  className="social-btn"
                >
                  <EmailIcon />
                </a>
    ...
    .skills-fade-enter {
      animation: skillsFadeIn 0.35s ease forwards;
    }
  ...
  `}</style>
          ...
          {(() => {
            const skillGroups = {
              ...
              Design: ["Figma", "Adobe Audition", "GIMP", "Canva"],
              Concepts: [
                "OOP",
                "REST APIs",
                "Data Structures",
            ...
            const tags = skillGroups[activeTab];
            const row1 = tags.slice(0, Math.ceil(tags.length / 2));
            const row2 = tags.slice(Math.ceil(tags.length / 2));
            // Pad short rows so marquee looks full
            const pad = (arr) => {
              let out = [...arr];
              while (out.length < 10) out = [...out, ...arr];
              return out;
            };
            ...
            return (
              <div>
                ...
                <div
                  key={animKey}
                  className="marquee-wrapper skills-fade-enter"
                  style={{
                    display: "flex",
                    flexDirection: "column",
                    gap: "14px",
    ...
    .proj-tab:hover { border-color: rgba(0,229,160,0.5); color: #e8eaf0; }
    .proj-tab.active {
      background: rgba(0,229,160,0.12);
      border-color: #00e5a0;
      color: #00e5a0;
    ...
    .proj-grid-enter {
      animation: projFadeIn 0.4s ease forwards;
    }
  ...
  `}</style>
            ...
            const allProjects = [
              {
                title: "EPA ESA Web App",
                role: "User Research Lead",
                desc: "Led user research for a 3-person team to design a centralized web platform helping farmers identify compliant pesticide options by region and regulation. Created an interactive Figma prototype and supported development with React Native.",
                link: "",
                tags: ["React Native", "Figma", "JavaScript"],
                category: "Frontend",
              },
              {
                title: "Overwatchful",
                role: "Developer",
                desc: "Solo full-stack stats tracker for Overwatch 2. Search any player to view rank, time played, shop updates, and more. Built with React, Tailwind, and Supabase.",
                link: "https://github.com/madi6116/OW2-Stats-Tracker",
              ...
              },
              {
                title: "Campus Essentials Hub",
                role: "Designer",
                desc: "Ideathon project — a mobile app centralizing campus aid, filtering resources by eligibility, and gamifying engagement to help SJSU students access the support they need.",
                link: "https://www.figma.com/proto/ay65PCiQElNKbUrZYl3UXi/Hacktivism-II-Mockups---Fall-2025",
                tags: ["Figma", "UX Research", "Prototyping"],
                category: "Design",
              },
              {
                title: "Eco Choices",
                role: "Designer",
                desc: "STEMpower Hacks Hackathon — a mobile game encouraging sustainable daily choices. Designed the UI/UX and created a Figma prototype for user testing.",
                link: "https://www.linkedin.com/in/madison-ammirati/overlay/Project/1415640629/treasury/?profileId=ACoAAEcpmVEBlc5uJnZTn34-Xdh2TulTDI5SNUI",
                tags: ["Figma", "Wireframing", "Prototyping"],
                category: "Design",
              },
              ...
              <div>
                ...
                >
                  {projectCategories.map((cat) => (
                    <button
                      key={cat}
                      className={`proj-tab${activeFilter === cat ? " active" : ""}`}
                ...
                >
                  {filtered.map((proj, i) => {
                    const style =
                      catStyle[proj.category] ?? catStyle["Frontend"];
                    return (
                      <Reveal
                        key={proj.title}
                        delay={i * 0.08}
        ...
        <section
          id="contact"
          className="section"
          style={{ maxWidth: "600px", margin: "0 auto", padding: "100px 24px" }}
        >
          ...
          <Reveal>
            <div className="card" style={{ padding: "48px 40px" }}>
              ...
              <form
                action="https://formspree.io/f/xblzagyy"
                method="POST"
                style={{
                  display: "flex",
                  flexDirection: "column",
        ...
        >
          ...
          >
            ...
            <a href="mailto:madison.ammirati@gmail.com" className="social-btn">
              <EmailIcon />
            </a>
          </div>
          <p
